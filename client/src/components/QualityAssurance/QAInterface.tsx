...
const QAInterface: React.FC = () => {
        ...
        return (
                <div className="p-6 bg-white rounded-lg flex">
                        <h4 className="animate-pulse text-xl font-bold mb-6 text-purple-800 shadow-lg p-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-600 text-white">Select dataset for QA</h4>
                        <select className="ml-10 p-2 border border-gray-300 rounded bg-grey text-purple-600 font-bold mb-4" onChange={handleFolderSelection}>
                        ...
                        <button
                                ...
                                className="ml-10 w-full px-4 bg-white text-purple-600 font-bold py-3 rounded-lg shadow-lg hover:bg-gradient-to-r from-purple-600 to-green-400 hover:text-white transition"
                        >
