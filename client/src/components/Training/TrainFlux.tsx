                ...
                <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-yellow-300 flex items-center justify-center p-4">
                        ...
                        <div className="text-center max-w-md w-full space-y-6">
                                ...
                                <div className="animate-bounce text-2xl font-bold text-white">
                                        Select a Dataset To Train a Flux-dev LoRA!
                                </div>
                                {/* Selection box */}
                                <select
                                        className="w-full p-3 rounded-lg bg-white border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
                                        value={dataset}
