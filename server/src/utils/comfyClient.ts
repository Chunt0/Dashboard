// TODO: THIS IS JUST A DIRECT COPY OF websockets_api_example.py -> this must be fixed so that it can properly make requests to the comfy server and maintain a websocket connection in order to alert the client the generation has been completed and send the image to the frontend
